function [cv_logL,cv_logL_trial] = group_cvSDRM4c_sigma0(jol_data,nratings)
% cross_validation analysis for Model 4c of SDRM (with sigma_M and sigma_c as 0)
...
for i = 1:nsubj
    ...
    [cv_logL(i),cv_logL1,cv_logL2] = cv_sdrm4c_sigma0(jol_data_sub1(:,3:4),jol_data_sub2(:,3:4),nratings);
