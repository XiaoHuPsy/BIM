function [params,logL,predicted] = group_fitSDRM4c_sigma0(jol_data,nratings)
% fit Model 4c of SDRM (with sigma_M and sigma_c as 0) to JOL data
% (with 2 conditions) from a group of participants
...
params = zeros(nsubj,nratings+4); % BIM parameters
...
for i = 1:nsubj
    ...
    % fit sdrm
    [params(i,:),logL(i),predicted(i,:)]=fit_sdrm4c_sigma0(nC1,nC2,nI1,nI2);
