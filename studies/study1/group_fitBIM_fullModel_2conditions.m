function [params,logL,warning,padding] = group_fitBIM_fullModel_2conditions(jol_data)
...
for i = 1:nsubj
    ...
    [params_tmp,logL(i,1),warning(i,:)]=fit_bim_fullModel(jol_data_sub1(:,3:4),jol_data_sub2(:,3:4));
    ...
    if padding1(i) ~= 0 || padding2(i) ~= 0
        [params_tmp,logL(i,1),warning(i,:)]=fit_bim_fullModel(jol_data_sub1(:,3:4),jol_data_sub2(:,3:4),padding1(i),padding2(i)); % padding correction
        params1(i,:) = params_tmp(1:4);
        params2(i,:) = params_tmp(5:8);
    end
