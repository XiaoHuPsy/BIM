...
for i = 1:size(params,2)
    ...
    % simulate data
    observed_data = BIM_simulation_recog(params(1,i),Mconf1,Mconf2,Mconf3,Mconf4,params(2,i),d,C,ntrial);
    ...
    filename = sprintf('fig_pexp_%2.1f_mconf_%2.1f_rho_%2.1f',params(1,i),Mconf1,params(2,i));
